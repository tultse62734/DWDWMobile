...
public interface DWDWRepositories {
    ...
    void GetUsetInfor(Context context,String token, CallBackData<UserDTO1> mCallBackData);
    void UpdateAccout(Context mContext, String token , UserDTO1 mUserDTO, CallBackData<UserDTO1> mCallBackData);
