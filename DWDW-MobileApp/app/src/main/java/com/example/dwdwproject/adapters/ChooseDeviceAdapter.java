...
public class ChooseDeviceAdapter extends RecyclerView.Adapter<ChooseDeviceAdapter.DeviceViewHolder> implements Filterable {
    ...
    public ChooseDeviceAdapter(Context mContext, List<Device> mDeviceList) {
